...
if __name__ == '__main__':
    ...
    y= librosa.load(args.wav_in, sr=fs)
    print(fs)
    ...
    plt.plot(pitches,t, label = "pitches")
    #plt.plot(gaussian_filter1d(pitches, 5),t, label = "pitches_filt")
    #plt.plot(o_env,t, label='Onset Envelope')
