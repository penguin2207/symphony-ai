...
if __name__ == '__main__':
    ...
    pitches = []
    for i in range(data_filt.shape[0] // (window+3)):
        print("Window: ", (i+1), "/", (data_filt.shape[0] // (window+3)))
    ...
    print(args.wav_in)
    o_env = librosa.onset.onset_strength(y=data_filt, sr=fs)
    print(o_env)
